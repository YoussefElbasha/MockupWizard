...
import { ChevronBack, ChevronBackCircle, ColorPalette, Images, Rocket } from 'react-ionicons'
...
const EditorTabs = forwardRef<HTMLCanvasElement, EditorTabsProps>(
  (props, ref) => {
    ...
    return (
      <>
        <Link href="/dashboard" className="absolute w-10 h-10 p-2 transition-all duration-300 ease-in-out bg-white rounded-full top-6 left-6 hover:bg-neutral-200/60">
